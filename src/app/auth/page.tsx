  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Badge — matching homepage green pill */}
        <div style={{
        ...
        {/* Headline — matching homepage gradient */}
        <h1 style={{
          fontSize: "52px", fontWeight: 800, lineHeight: 1.1,
          color: "#fff", marginBottom: "20px", maxWidth: "500px",
        }}>
          Understand any{" "}
          <span style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginBottom: "20px" }}>
            <button
              ...
              style={{
                ...
                border: "1px solid rgba(255,255,255,0.08)",
                background: "rgba(255,255,255,0.04)",
                color: "#d1d5db", cursor: "pointer", fontSize: "13px",
          ...
          <p style={{ textAlign: "center", fontSize: "11px", color: "#4b5563", marginTop: "16px" }}>
            ...
            <span style={{ color: "#06b6d4", cursor: "pointer" }}>Terms of Service</span>
          </p>
        </div>
      </div>
    </div>
